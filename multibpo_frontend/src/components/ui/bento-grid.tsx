...
const BentoCard = ({
  ...
  >
    ...
    >
      <a
        href={href}
        className="pointer-events-auto text-blue-600 font-medium hover:text-blue-700 transition-colors duration-200 group cursor-pointer text-sm inline-flex items-center"
      >
        {cta}
